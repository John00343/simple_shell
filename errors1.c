 ...
 * Return: 0 if NILL int in string, converted number else
 *        -1 on error
 */
...
/**
 * print_d - function will prints decimal (int) number (base 10)
 * @input: the input
...
/**
 * convert_number - Is converter function, a clone of itoa
 * @num: number
 * @base: base
...
/**
 * remove_comments - WIll replace first instance of '#' with '\0'
